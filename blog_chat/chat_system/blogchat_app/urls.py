...
from .views import PostView, about_view, index_view, contact_view, my_blog_view,register_request,login_request,logout_request,edit_profile_view

urlpatterns = [
    path('',index_view,name='index_page'),
    path('post-detail/<int:post_id>/',PostView.as_view(),name='detail_page'),
